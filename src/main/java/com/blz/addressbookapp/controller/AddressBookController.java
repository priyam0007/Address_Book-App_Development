...
public class AddressBookController {
    ...
    public ResponseEntity<ResponseDTO> getAllAddressbookData(){
        List<AddressBookData> addressBookData =iAddressBookService.getAllAddressBookData();
    ...
    public ResponseEntity<ResponseDTO> getAddressBookData(@PathVariable int id){
        AddressBookData addressBookData=iAddressBookService.getAddressBookData(id);
        ResponseDTO responseDTO=new ResponseDTO("Get call Success",addressBookData);
        return  new ResponseEntity<ResponseDTO>(responseDTO, HttpStatus.OK);
    }
    ...
    public ResponseEntity<ResponseDTO> sortByState() {
        List<AddressBookData> addressBookList = null;
        addressBookList = iAddressBookService.sortAddressBookByState();
